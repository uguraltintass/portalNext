            ...
            <div className="col-lg-6 order-2 order-lg-1">
              <ul className="list-inline" data-aos="fade-right">
                <li className="list-inline-item">
                  <div className="badge bg-primary fw-normal rounded-0">
                    {category}
                  </div>
                </li>
              </ul>
              <h2
                className="h1 text-xxl text-shadow"
                data-aos="fade-right"
                data-aos-delay="100"
              >
                {title}
              ...
              >
                ...
                <li
                  className="list-inline-item ms-2 lh-1"
                ...
                <li className="list-inline-item">
                  <span className="small ms-2">
                    <CgTimer className="text-warning me-2" size="1.4rem" />{" "}
                    {duration}
                  </span>
                </li>
              </ul>
              <p
                className="text-gray-500 lead fw-light mb-4"
                data-aos="fade-right"
                data-aos-delay="300"
              >
